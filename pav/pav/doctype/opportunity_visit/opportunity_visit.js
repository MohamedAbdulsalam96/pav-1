...
var serial_nos = [];
frappe.ui.form.on('Opportunity Visit', {
...
pav.pav.OpportunityVisit = frappe.ui.form.Controller.extend({
	refresh: function () {
		...
		if (this.frm.doc.docstatus === 0) {
			this.frm.add_custom_button(__('Opportunity Schedule'),
				function () {
					...
					erpnext.utils.map_current_doc({
						...
						source_doctype: "Opportunity Schedule",
						target: me.frm,
						setters: {
...
$.extend(cur_frm.cscript, new pav.pav.OpportunityVisit({ frm: cur_frm }));
